                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                ...
                                class="mb-4 rounded-circle"
                                >
                                <h3 class="mb-4">Edo</h3>
                                <p class="testimonial">
                                    "The trip was amazing and I saw something beatiful in that island that makes me  want to learn more"
                                </p>
                            </div>
                            <hr>
                            <p class="trip-to mt-2">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                ...
                                class="mb-4 rounded-circle"
                                >
                                <h3 class="mb-4">Rexy</h3>
                                <p class="testimonial">
                                    "I loved it it when the waves was shaking harder -  I was scared too "
                                </p>
                            </div>
                            <hr>
                            <p class="trip-to mt-2">
