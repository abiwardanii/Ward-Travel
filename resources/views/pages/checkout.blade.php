                                ...
                                <div class="member mt-3">
                                    ...
                                    @csrf
                                        ...
                                        <select name="is_visa" id="is_visa" class="custom-select mb-2 mr-sm-2" required>
                                            ...
                                            <option value="1"VISA>30 Days</option>
                                    ...
                                    <p class="disclaimer mb-0">
                                        You are only able to invite member that has registered in Ward Travel.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="card card-details card-right">
                                ...
                                <div class="member my-2">
                                    <img src="{{url('frontend/images/member1.png')}}" class="member-image mr-1 rounded-circle">
                                    <img src="{{url('frontend/images/member2.png')}}" class="member-image mr-1 rounded-circle">
                                    <img src="{{url('frontend/images/member3.png')}}" class="member-image mr-1 rounded-circle">
                                    <img src="{{url('frontend/images/member4.png')}}" class="member-image mr-1 rounded-circle">
                                </div>
                                <hr>
    ...
    <script>
        $(document).ready(function(){
            $('.datepicker').datepicker({
                ...
                icons : {
                    rightIcon: '<img src="{{url('frontend/images/ic-doe.png')}}" />'
                }
            });
        });
    </script>
